...
//If you have implement wifi_plat_data, please take off CONFIG_DTS below

#ifdef CONFIG_DTS  

        //wifi_card_detect();  customer need to implement card detect function here !!

#else

        // or implement card detect function through wifi_plat_data
	if (!adapter || !adapter->wifi_plat_data)
		return -EINVAL;
	plat_data = adapter->wifi_plat_data;
